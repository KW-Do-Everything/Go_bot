...
# 실행할 외부 프로그램의 경로
exe_path = '/home/capstone/Othello_bot/Egaroucid-console_v7.3.0/bin/Egaroucid_for_Console.out'
...
#########****************************************************###############
    ...
    def read_equal2question(self):
        return self.read_from_to("=","? [ERROR] command not found")
...
# 추천수 확인
    def reg_genmove(self, color):
        self.write("reg_genmove " + str(color))
        answer = self.readline().strip()
        answer = answer.split(" ")[1]
        return answer
...
def main():
    ...
    i = 0
    while i < 5:
        print(kata.reg_genmove("black"))
        kata.play_black()
        print(kata.check_board())
        print(kata.board_show())

        print(kata.reg_genmove("white"))
