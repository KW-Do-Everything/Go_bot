...
class Vision(metaclass=Metaclass_Vision):
    ...
    def __init__(self, **kwargs):
        ...
        self.check_vision = kwargs.get('check_vision', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.check_vision != other.check_vision:
            return False
        return True
    ...
    def check_vision(self):
        """Message field 'check_vision'."""
        return self._check_vision

    @check_vision.setter
    def check_vision(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'check_vision' field must be of type 'bool'"
        self._check_vision = value
