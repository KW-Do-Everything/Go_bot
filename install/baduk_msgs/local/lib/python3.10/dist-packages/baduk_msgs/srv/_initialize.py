...
class Initialize_Request(metaclass=Metaclass_Initialize_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.do_initialize = kwargs.get('do_initialize', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.do_initialize != other.do_initialize:
            return False
        return True
    ...
    def do_initialize(self):
        """Message field 'do_initialize'."""
        return self._do_initialize

    @do_initialize.setter
    def do_initialize(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'do_initialize' field must be of type 'bool'"
        self._do_initialize = value
...
class Initialize_Response(metaclass=Metaclass_Initialize_Response):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.done_initialize = kwargs.get('done_initialize', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.done_initialize != other.done_initialize:
            return False
        return True
    ...
    def done_initialize(self):
        """Message field 'done_initialize'."""
        return self._done_initialize

    @done_initialize.setter
    def done_initialize(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'done_initialize' field must be of type 'bool'"
        self._done_initialize = value
...
class Metaclass_Initialize(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from baduk_msgs.srv import _initialize
...
class Initialize(metaclass=Metaclass_Initialize):
    from baduk_msgs.srv._initialize import Initialize_Request as Request
    from baduk_msgs.srv._initialize import Initialize_Response as Response
